...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_student_behaviors_id"), "student_behaviors", ["id"], unique=False
    )
    op.create_table(
        "student_progress",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_student_progress_id"), "student_progress", ["id"], unique=False
    )
    op.create_table(
        "student_questions",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_student_questions_id"), "student_questions", ["id"], unique=False
    )
    op.create_table(
        "sections",
        sa.Column("id", sa.Integer(), nullable=False),
